...
// const baseURL = 'https://www.vouchercodes.co.uk/';
...
exports.config = {
    ...
    afterStep: function ({ uri, feature, step }, context, { error, result, duration, passed, retries }) {
        if (error) {
            const f_name = 'scr_' + (new Date(Date.now()).toISOString()) + '.png';
            console.log('error on afterStep ->' + f_name);
            browser.saveScreenshot('./screenshots/' + f_name);
        }
    },
    /**
